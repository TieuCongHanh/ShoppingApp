...
public class ProductsAddCart {
    ...
    private int pricetotal_product;

    public ProductsAddCart() {
    }

    public ProductsAddCart(String id_user, String id_product, String name_product, String image_product, int num_product, int pricetotal_product) {
    ...
    public int getPricetotal_product() {
        return pricetotal_product;
    }

    public void setPricetotal_product(int pricetotal_product) {
        this.pricetotal_product = pricetotal_product;
    }
}
